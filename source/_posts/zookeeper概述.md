...
{% asset_img ZooKeeper-Service.jpg ZooKeeper Service %}
...
{% asset_img zknamespace.jpg zk namespace %}
...
{% asset_img zkcomponents.jpg zk components %}
...
{% asset_img zkthrought.png zk throught %}
...
Benchmarks也表明ZooKeeper是可靠的。下图（可靠性中的图）显示了ZooKeeper在各种失败情况下的反应。图中标记的各个事件是：
...
{% asset_img zkperfreliability.jpg zk performance reliability %}
...
我们鼓励用户和开发者加入社区，贡献技能。更多信息请看[Apache的ZooKeeper工程](http://hadoop.apache.org/zookeeper/)。
